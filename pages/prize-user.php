...
<?php
	...
	<p>We just need to know who you are so we can send you your prize!</p>
			<form action='user-confirmation.php' id='user-form' method='get' enctype='multipart/form-data'><br>
